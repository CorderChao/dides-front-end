...
export class TopbarComponent implements OnInit {
  ...
  windowScroll() {
    let topBarElement = document.getElementById("back-to-top") as HTMLElement;
    let topBarClassList = document.getElementById("page-topbar")?.classList;
    if (
      ...
      topBarClassList?.add("topbar-shadow");
    } else if (topBarElement && topBarElement.style) {
      topBarElement.style.display = "none";
      topBarClassList?.remove("topbar-shadow");
    }
  }
